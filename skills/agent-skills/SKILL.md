---
name: Agent Skills
description: Explain, inspect, create, and maintain ArkBrain-Agent Agent Skills packages built around SKILL.md instructions.
tags:
  - skills
  - agent
  - workflow
...
Use this skill when the user asks about ArkBrain-Agent skills, wants to list installed skills, or wants to create a reusable workflow package.

## ArkBrain-Agent Skill Format

A ArkBrain-Agent Agent Skill is a folder under the configured skills root. The required file is `SKILL.md`.
...
- Keep `description` specific. ArkBrain-Agent uses it during skill selection.
